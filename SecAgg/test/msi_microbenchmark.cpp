...
// uint64_t prime_mod = 17592060215297;  //corresponding bitlen = 44
uint64_t prime_mod = 576460752034988033;    //corresponding bitlen = 59
seal::Modulus mod(prime_mod);
int port = 32000, def_nrelu = 1<<20, l = 59;  //44->59
