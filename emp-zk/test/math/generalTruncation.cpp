...
int main(int argc, char **argv)
{
	...
	std::cout << std::endl
			  << "------------ ZKgeneralTruncAny test ------------" << std::endl
			  << std::endl;
	...
	cout << "time - ZKgeneralTruncAny (ms): " << time / 1000 << " ms\t " << party << endl;
	uint64_t com1 = comm(ios) - com;
	std::cout << "communication - ZKgeneralTruncAny (KB): " << com1 / 1024.0 << std::endl;
