...
Terminal 1: bin/test_msi_microbenchmark 1 0.0.0.0 31000 59 0 16384 8 
Terminal 2: bin/test_msi_microbenchmark 2 127.0.0.1 31000 59 0 16384 8 
```
...
# Our compilation：
1. For multi-threading support, go to `emp-tool` and run the following:
```
cmake . -DTHREADING=ON
make -j
sudo make install
